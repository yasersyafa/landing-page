...
const Modal = ({isVisible, onClose}) => {
  ...
  return (
    <div className='fixed inset-0 bottom-0 w-full h-full max-h-1/2 bg-black bg-opacity-25 max-h-1/2 backdrop-blur-lg z-40 transition duration-500 ease-in-out' onClick={() => onClose()}>       
